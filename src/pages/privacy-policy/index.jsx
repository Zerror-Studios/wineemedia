        ...
        <div className="space-y-[5vw]">
          ...
          <div>
            ...
            <p className="font-[heading2] text-[4vw] sm:text-[1.2vw] leading-relaxed">
              ...
              number, business details, and any information you provide when you
          ...
          <div>
            ...
            <ul className="list-disc pl-[5vw] sm:pl-[2vw] font-[heading2] text-[4vw] sm:text-[1.2vw] leading-relaxed mt-[1vw]">
              ...
              <li>
                Communicate with you regarding inquiries and consultations.
              </li>
          ...
          <div>
            ...
            <p className="font-[heading2] text-[4vw] sm:text-[1.2vw] leading-relaxed">
              ...
              and conditions. Winee Media reserves the right to modify, update,
              or discontinue any part of the website or services at any time.
            </p>

            <p className="font-[heading2] text-[4vw] sm:text-[1.2vw] leading-relaxed mt-[1vw]">
              Our services are designed to help founders improve their personal
              branding and online presence. Results may vary depending on
              individual effort, market conditions, and business factors.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="font-[heading2] text-[4vw] sm:text-[1.2vw] leading-relaxed">
              If you have any questions regarding this Privacy Policy Policy,
              you can contact us through our official communication channels.
            </p>
          </div>
