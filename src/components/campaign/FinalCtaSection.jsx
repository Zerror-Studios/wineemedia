...
const FinalCtaSection = () => {
  return (
    <section
      id="booking-section"
      className="w-full px-[4vw] sm:px-[2vw] py-[6vw] sm:py-[3vw] pb-[14vw] sm:pb-[8vw] text-center"
    >
      <SectionHeaderLight
        title="Book a Call"
        fullWidthLine
        contentClassName="w-full sm:w-[63%] md:w-[70%] lg:w-[60%] mx-auto"
      />

      <div className="w-full flex justify-center">
        <div className="w-full sm:w-[63%] md:w-[70%] lg:w-[60%] mx-auto">
          ...
          <h3 className="font-[heading2] tracking-wide text-black text-[4vw] md:text-[2vw] mb-[5vw] sm:mb-[3vw]">
  You Have Built a Good Business. Now Build the{" "}
...
<p className="font-[heading2] tracking-wide text-[4vw] sm:text-[1.8vw] md:text-[1.4vw] lg:text-[1.25vw] text-black mb-[3vw] sm:mb-[1.5vw]">
  Right now a founder in your space is building an{" "}
  <span className="text-[#512477]">
    audience
  </span>
  , earning{" "}
  ...
  , and turning followers into{" "}
  <span className="inline-block bg-[#512477] text-white px-[1vw] py-[0.2vw] rounded-[0.4vw]">
    paying customers
  </span>
  , before those people ever find you. That gap widens every single month.
</p>
