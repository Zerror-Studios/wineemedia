    ...
    >
      ...
      <div className="w-full flex justify-center">
        <div className="w-full sm:w-[63%] md:w-[70%] lg:w-[60%]">
          ...
          <p className="font-[heading2] tracking-wide text-[4vw] sm:text-[1.8vw] md:text-[1.4vw] lg:text-[1.25vw] text-white mb-[3vw] sm:mb-[1.5vw]">
          ...
          <p className="font-[heading] tracking-wide text-[4vw] sm:text-[1.8vw] md:text-[1.4vw] text-white mb-[8vw] sm:mb-[4vw]">
            One conversation changes that.
          </p>

          <CtaButton id="final-section-cta" />

          <div className="mt-[8vw] sm:mt-[4vw] border-t border-white/20 pt-[4vw] sm:pt-[2vw]">
            <p className="font-[heading2] tracking-wide text-[3.8vw] sm:text-[1.5vw] md:text-[1.15vw] text-white mb-[2vw] sm:mb-[1vw]">
              On the call we look at your business, your story, and exactly what
              your personal brand could look like in 90 days.
            </p>
            <p className="font-[heading2] tracking-wide text-[3.5vw] sm:text-[1.4vw] md:text-[1.05vw] text-white/50">
