...
const CtaButton = ({ id, label = "Book Your Founder Strategy Call", className = "" }) => {
  return (
    <a
      id={id}
      ...
      onClick={trackLead}
      className={`viewall overflow-hidden effecttxt border border-white px-[6vw] sm:px-[3vw] md:px-[2vw] relative rounded-full py-[2vw] sm:py-[1vw] md:py-[.7vw] text-white inline-flex items-center gap-[1vw] cursor-pointer ${className}`}
    >
