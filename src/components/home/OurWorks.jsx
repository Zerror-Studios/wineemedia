    ...
    <div className="our-works w-full py-[2vw] pb-[10vw] sm:pb-[6vw] bg-black">
      <div className="select-work2 relative w-full mx-[2vw] py-[5vw] sm:py-[1.2vw] flex mt-[6vw]">
        <div className="overflow-hidden">
          <h3
            className="work-txt2 text-black text-[10vw] sm:text-[3.5vw] font-[heading2] leading-none capitalize"
      ...
      <div className="">
        {servicesData.map((service, index) => (
          ...
          >
            <h4 className="z-10 text-[6.2vw] sm:text-[4.2vw] md:text-[3.2vw] font-[heading2] sm:font-semibold pointer-events-none">
              {service.title}
            </h4>
            <h5 className="z-10 hidden md:block w-[25%] text-right md:text-[1.1vw]">
              {service.description}
            </h5>
            ...
            <div className="w-full h-full overflow-hidden absolute pointer-events-none top-0 z-[11] left-0">
              <div
                ...
                className={`back-slide w-full h-full absolute px-[4vw] sm:px-[2vw] top-full z-[9] left-0  text-white flex items-center justify-between`}
              >
                <h4
                  style={{ color: service.text }}
                  className="text-[6vw] sm:text-[4vw] md:text-[3vw] font-[heading2] sm:font-semibold pointer-events-none"
                >
                  {service.title}
                </h4>
                <h5
                  style={{ color: service.text }}
                  className="hidden md:block w-[25%] text-right md:text-[1.1vw]"
                >
                  {service.description}
                </h5>
              </div>
