    ...
    <div className="section4-h w-full min-h-screen bg-black">
      <div className="select-work relative w-full mx-[2vw] py-[5vw] sm:py-[1.2vw] mt-[6vw]">
        <div className="overflow-hidden">
          <h2
            className="work-txt text-white  pl-[2vw] sm:pl-0 text-[10vw] sm:text-[3.5vw] font-[heading2] leading-none"
      ...
      <div className="projects w-full hidden sm:flex justify-between flex-wrap pt-[5vw] sm:pt-[2vw] p-[2vw] pb-[0]">
        {works.map((w, i) => (
          <Link
            href={`/work/${w.projectname.split(" ").join("-")}`}
            title={w.projectname}
            key={i}
            ...
            className="img-clip project-h cursor-pointer w-full sm:w-full md:w-[49%] h-[60vh] sm:h-[90vh] mb-[2%] overflow-hidden relative"
          >
            ...
            <div className="strip-text w-full text-white capitalize  transition-all duration-500 text-[4vw] sm:text-[2vw] md:text-[1.8vw] lg:text-[1.3vw] xl:text-[1.2vw] font-[heading] h-[10%]  absolute  opacity-0 bottom-0 left-0 z-[10]  hidden sm:flex flex-col items-start justify-center">
              ...
              <div className="flex items-center justify-between w-[100%]">
                <h5>
                  {w.serviceprovided?.split(", ").slice(0, 3).join(", ")}
                  {w.serviceprovided.split(", ").length > 3 && "..."}
                </h5>
                <h6>
                  Discover <i className="ri-arrow-right-line"></i>
                </h6>
              </div>
            </div>
            <Image
              width={1000}
              height={1000}
              className="project-ig w-full h-full object-cover"
              src={w.coverimage1}
              alt={w.projectname}
              title={w.projectname}
            />
      ...
      <div className="projects w-full flex sm:hidden justify-between flex-wrap pt-[5vw] sm:pt-[2vw] p-[4vw] pb-[0]">
        {works.map((project, i) => (
          <Link
            ...
            className="project w-full md:w-[49.5%] mb-[10vw] cursor-pointer"
          >
            ...
            <h4 className="text-white font-[heading] text-[4vw] sm:text-[3vw] tracking-wide md:text-[1.4vw] lg:text-[1.4vw]  mt-[4vw] md:mt-[.5vw] capitalize">
              {project.projectname}
            </h4>
            <p className="text-white opacity-[.8] tracking-wide  mt-[2vw] sm:mt-0 font-[heading2] text-[4vw] sm:text-[2vw] md:text-[1vw] lg:text-[1.2vw] capitalize w-full md:w-[50%]">
      ...
      <div className="flex items-center justify-center py-[3vw] pt-[5vw] sm:pt-[1vw]">
        <Link
          href="/work"
          title="view all"
          className="viewall overflow-hidden effecttxt border border-white px-[6vw] sm:px-[3vw] md:px-[2vw] relative rounded-full py-[2vw] sm:py-[1vw] md:py-[.7vw] text-white flex items-center gap-[1vw] mix-blend-difference  cursor-pointer"
        >
